...
g6_1.default.registerNode('card-node', {
    draw: function (cfg, group) {
        ...
        style = __assign({ radius: 2, fill: '#fff' }, style);
        ...
        // title text
        var title = (cfg === null || cfg === void 0 ? void 0 : cfg.title) || (cfg === null || cfg === void 0 ? void 0 : cfg.label);
        var titleTextShape;
...
g6_1.default.registerNode('round-rect', {
...
var customIconNode = function (params) {
    g6_1.default.registerNode('icon-node', {
        options: {
            size: [60, 20],
            stroke: '#91d5ff',
            fill: '#91d5ff',
        ...
        draw: function (cfg, group) {
            ...
            if (cfg === null || cfg === void 0 ? void 0 : cfg.leftIcon) {
            ...
            if (params.enableEdit) {
                group.addShape('marker', {
                    attrs: {
                        ...
                        stroke: '#73d13d',
                        cursor: 'pointer',
                        symbol: g6_1.default.Marker.expand,
                    },
                    name: 'add-item',
                });
                group.addShape('marker', {
                    attrs: {
                        ...
                        stroke: '#ff4d4f',
                        cursor: 'pointer',
                        symbol: g6_1.default.Marker.collapse,
                    },
                    name: 'remove-item',
                });
            }
...
g6_1.default.registerEdge('fund-polyline', {
    draw: function draw(cfg, group) {
        var startPoint = cfg === null || cfg === void 0 ? void 0 : cfg.startPoint;
        var endPoint = cfg === null || cfg === void 0 ? void 0 : cfg.endPoint;
        ...
        var line = group.addShape('path', {
            attrs: {
                path: path,
                stroke: style.stroke || ((cfg === null || cfg === void 0 ? void 0 : cfg.colorMap) && cfg.colorMap[cfg.dataType])
...
g6_1.default.registerEdge('flow-line', {
    draw: function (cfg, group) {
        var startPoint = cfg === null || cfg === void 0 ? void 0 : cfg.startPoint;
        var endPoint = cfg === null || cfg === void 0 ? void 0 : cfg.endPoint;
