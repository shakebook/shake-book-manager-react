 ...
 */
import { Edge, OutNode, PointTuple, ComboConfig } from './types';
...
export declare class ComboForceLayout extends Base {
    ...
    constructor(options?: ComboForceLayout.ComboForceLayoutOptions);
    getDefaultCfg(): {
        maxIteration: number;
        center: number[];
        gravity: number;
...
export declare namespace ComboForceLayout {
    interface ComboForceLayoutOptions {
        type: 'comboForce';
        center?: PointTuple;
        maxIteration?: number;
        linkDistance?: number | ((d?: unknown) => number);
