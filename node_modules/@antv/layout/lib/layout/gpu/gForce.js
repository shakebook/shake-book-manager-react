...
var layoutConst_1 = require("../worker/layoutConst");
/**
 * graphin 中的 force 布局
 */
var GForceGPULayout = /** @class */ (function (_super) {
    ...
    GForceGPULayout.prototype.run = function (canvas, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var self, nodes, edges, maxIteration, numParticles, _a, maxEdgePerVetex, nodesEdgesArray, masses, nodeStrengths, centerXs, centerYs, centerGravities, gravity, center, nodeAttributeArray1, nodeAttributeArray2, workerEnabled, world, onLayoutEnd, initPreviousData, i, kernelGForce, kernelAveMovement, execute;
            var _this = this;
                    ...
                    case 0:
                        ...
                        nodes.forEach(function (node, i) {
                            ...
                            if (self.getCenter) {
                                ...
                                if (customCenter && util_1.isNumber(customCenter[0])
                                    && util_1.isNumber(customCenter[1]) && util_1.isNumber(customCenter[2])) {
                                ...
                                switch (_a.label) {
                                    ...
                                    case 6:
                                        ...
                                        if (canvas) {
                                            // 传递数据给主线程
                                            ctx.postMessage({
                                                type: layoutConst_1.LAYOUT_MESSAGE.GPUEND,
