...
function () {
  function TrendTimeBar(cfg) {
    ...
    this.currentSpeed = controllerCfg.speed || 1; // style
  ...
  TrendTimeBar.prototype.renderSlider = function () {
    ...
    this.minHandlerShape = new _handler.default(__assign({
      name: 'minHandlerShape',
    ...
    this.maxHandlerShape = new _handler.default(__assign({
      name: 'maxHandlerShape',
    ...
    this.controllerBtnGroup = new _controllerBtn.default(__assign({
      ...
      width: width,
      height: 40
    }, this.controllerCfg)); // 根据 start end 更新 ui 的位置信息
