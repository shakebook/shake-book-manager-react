...
function pieAnnotation(params) {
    ...
    if (innerRadius && statistic) {
        ...
        utils_1.renderStatistic(chart, { statistic: { title: title, content: content }, plotType: 'pie' });
    }
    return params;
}
...
function adaptorTooltipOptions(params) {
    return util_1.get(params, ['options', 'tooltip']) !== false
        ? utils_1.deepAssign({}, params, { options: { tooltip: { shared: false } } })
        : params;
}
/**
 * 饼图适配器
...
function adaptor(params) {
    ...
    return utils_1.flow(geometry, meta, common_1.theme, coordinate, common_1.legend, function (args) { return common_1.tooltip(adaptorTooltipOptions(args)); }, label, common_1.state, 
    /** 指标卡中心文本 放在下层 */
